...
public record
BasAccount(short code, String description, List<BasAccount> children, BasAccountClass accountClass) {
    ...
    public static enum BasAccountClass {
        ASSET, EQUITY_AND_LIABILITIES, REVENUE, COST, RESULT, UNDETERMINED, ACCOUNT_CHART;
